...
class Cache {
    constructor() {
        ...
        tslib.__classPrivateFieldSet(this, _Cache_store, new Map(), "f");
    }
    get(key) {
        const data = tslib.__classPrivateFieldGet(this, _Cache_store, "f").get(key);
        return data || null;
    }
    set(key, value, cacheTime) {
        tslib.__classPrivateFieldGet(this, _Cache_store, "f").set(key, {
            data: value,
            timeStamp: Date.now() + cacheTime,
        });
    }
    clear() {
        tslib.__classPrivateFieldGet(this, _Cache_store, "f").clear();
    }
    delete(key) {
        tslib.__classPrivateFieldGet(this, _Cache_store, "f").delete(key);
    }
}
_Cache_store = new WeakMap();

const parseResponse = (response, responseType) => tslib.__awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
const parseJson = (response) => tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
        return {
...
const parseeText = (response) => tslib.__awaiter(void 0, void 0, void 0, function* () {
    try {
        return {
...
class Api {
    ...
    get(url, options) {
        return tslib.__classPrivateFieldGet(this, _Api_instances, "m", _Api_useApi).call(this, METHODS.get, url, options);
    }
    post(url, options) {
        return tslib.__classPrivateFieldGet(this, _Api_instances, "m", _Api_useApi).call(this, METHODS.post, this.createUrl(url, options === null || options === void 0 ? void 0 : options.parameters), options);
    }
    put(url, options) {
        return tslib.__classPrivateFieldGet(this, _Api_instances, "m", _Api_useApi).call(this, METHODS.put, this.createUrl(url, options === null || options === void 0 ? void 0 : options.parameters), options);
    }
    delete(url, options) {
        if (isEndpoint(url)) {
            url = this.config.baseUrl + url;
        }
        return tslib.__classPrivateFieldGet(this, _Api_instances, "m", _Api_useApi).call(this, METHODS.delete, this.createUrl(url, options === null || options === void 0 ? void 0 : options.parameters), options);
    }
}
    ...
    return tslib.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (paramsOptions === null || paramsOptions === void 0 ? void 0 : paramsOptions.retry) {
                paramsOptions.retry--;
                return tslib.__classPrivateFieldGet(this, _Api_instances, "m", _Api_useApi).call(this, method, url, paramsOptions);
            }
...
function get(url, options) {
    return tslib.__awaiter(this, void 0, void 0, function* () {
        ...
        if (cachedResponse) {
            ...
            console.log("Cached time", cachedResponse.timeStamp);
